...
public class Cancellation {
	...
	public static void main(String[] args) throws Exception {
		...
		FileInputFormat.addInputPath(job, new Path("/workspaces/flight_analytics/dataset/final"));
		FileOutputFormat.setOutputPath(job, new Path("/workspaces/flight_analytics/dataset/output"));
